 ...
 */
public class GE_ItemStrawBed extends Item
{
    ...
    public boolean onItemUse(ItemStack p_77648_1_, EntityPlayer p_77648_2_, World p_77648_3_, int p_77648_4_, int p_77648_5_, int p_77648_6_, int p_77648_7_, float p_77648_8_, float p_77648_9_, float p_77648_10_)
    {
        ...
        {
            ++p_77648_5_;
            GE_BlockStrawBed blockStrawBed = (GE_BlockStrawBed) GE_BlockRegistry.blockStrawBed;
            ...
            if(p_77648_2_.canPlayerEdit(p_77648_4_, p_77648_5_, p_77648_6_, p_77648_7_, p_77648_1_) && p_77648_2_.canPlayerEdit(p_77648_4_ + b0, p_77648_5_, p_77648_6_ + b1, p_77648_7_, p_77648_1_))
            {
                ...
                {
                    p_77648_3_.setBlock(p_77648_4_, p_77648_5_, p_77648_6_, blockStrawBed, i1, 3);

                    if(p_77648_3_.getBlock(p_77648_4_, p_77648_5_, p_77648_6_) == blockStrawBed)
                    {
                        p_77648_3_.setBlock(p_77648_4_ + b0, p_77648_5_, p_77648_6_ + b1, blockStrawBed, i1 + 8, 3);
                    }
