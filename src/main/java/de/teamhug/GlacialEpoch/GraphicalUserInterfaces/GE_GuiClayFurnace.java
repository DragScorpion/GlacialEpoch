...
public class GE_GuiClayFurnace extends GuiContainer {
	
	public final ResourceLocation texture = new ResourceLocation(GE_Main.MODID, "textures/gui/GE_guiCampFire.png");
	public final GE_TileEntityClayFurnace tileEntity;
	
	public GE_GuiClayFurnace(InventoryPlayer inventory, GE_TileEntityClayFurnace te) {
		super(new GE_ContainerClayFurnace(inventory, te));
		this.tileEntity = te;
	}
